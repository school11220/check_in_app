...
export default function LoginPage() {
    ...
    return (
        <main className="min-h-screen flex items-center justify-center p-4 bg-[#ffe17c] noise-texture">
            {/* Background Effects */}
            <div className="light-surface glass-card w-full max-w-md p-8 rounded-3xl relative overflow-hidden animate-scale-in">
                ...
                <div className="text-center mb-8 relative z-10">
                    ...
                    <p className="text-[#36403b] text-sm">Sign in to your EventHub account</p>
                </div>
                ...
                <div className="relative z-10 flex items-center gap-4 mb-6">
                    ...
                    <span className="text-[#4b5651] text-xs uppercase tracking-wider">or</span>
                    <div className="flex-1 h-px bg-black/30"></div>
                </div>
                ...
                <form onSubmit={handleLogin} className="space-y-4 relative z-10">
                    ...
                    <div className="space-y-2">
                        <label className="text-xs font-semibold text-[#36403b] ml-1 uppercase tracking-wider">Email Address</label>
                        <div className="relative">
                            <Mail className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-[#4b5651]" />
                            <input
                                type="email"
                                value={email}
                    ...
                    <div className="space-y-2">
                        <label className="text-xs font-semibold text-[#36403b] ml-1 uppercase tracking-wider">Password</label>
                        <div className="relative">
                            <Lock className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-[#4b5651]" />
                            <input
                                type="password"
                                value={password}
                ...
                <div className="mt-8 text-center space-y-4">
                    <p className="text-[#4b5651] text-xs">
                        Don&apos;t have an account? <span className="font-semibold text-[#7a1020]">Contact your admin to get added</span>
                    </p>
                    <Link
                        href="/"
                        className="inline-flex items-center gap-2 text-[#36403b] hover:text-black text-sm font-medium transition-colors"
                    >
                        ← Go back to home
                    </Link>
                </div>
