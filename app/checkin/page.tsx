        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6 md:mb-8 glass p-4 md:p-5 rounded-2xl sticky top-2 z-40 backdrop-blur-xl bg-[#0B0B0B]/80 border border-white/5">
          <div className="flex items-center gap-3 md:gap-4">
            ...
            <div>
              ...
              <p className="text-[#737373] text-xs md:text-sm mt-0.5">Ready to scan tickets</p>
            </div>
          </div>
          ...
          <div className="flex justify-start md:justify-center overflow-x-auto scrollbar-hide -mx-4 px-4 md:mx-0 md:px-0">
            <div className="bg-[#141414] p-1.5 rounded-2xl border border-[#1F1F1F] inline-flex whitespace-nowrap shadow-xl">
              <button
                ...
                className={`px-4 md:px-6 py-2 md:py-2.5 rounded-xl text-xs md:text-sm font-medium transition-all flex items-center gap-2 ${activeTab === 'scanner' ? 'bg-[#E11D2E] text-white shadow-lg shadow-red-900/20' : 'text-[#737373] hover:text-white hover:bg-white/5'}`}
              >
              ...
              <button
                ...
                className={`px-4 md:px-6 py-2 md:py-2.5 rounded-xl text-xs md:text-sm font-medium transition-all flex items-center gap-2 ${activeTab === 'guestlist' ? 'bg-[#E11D2E] text-white shadow-lg shadow-red-900/20' : 'text-[#737373] hover:text-white hover:bg-white/5'}`}
              >
              ...
              <button
                ...
                className={`px-4 md:px-6 py-2 md:py-2.5 rounded-xl text-xs md:text-sm font-medium transition-all flex items-center gap-2 ${activeTab === 'stats' ? 'bg-[#E11D2E] text-white shadow-lg shadow-red-900/20' : 'text-[#737373] hover:text-white hover:bg-white/5'}`}
              >
              ...
              <button
                ...
                className={`px-4 md:px-6 py-2 md:py-2.5 rounded-xl text-xs md:text-sm font-medium transition-all flex items-center gap-2 ${activeTab === 'history' ? 'bg-[#E11D2E] text-white shadow-lg shadow-red-900/20' : 'text-[#737373] hover:text-white hover:bg-white/5'}`}
              >
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          {(activeTab === 'scanner') && (
            <div className="lg:col-span-2 grid grid-cols-1 lg:grid-cols-12 gap-6 animate-fade-in items-start">
              {/* Scanner - Takes up more space on large screens */}
